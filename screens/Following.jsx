...
const FollowingScreen = ()=>{
    ...
    const getSwipes = async () => {
        const res = await axios.post(`${server_api_base_url}following.php`, {
            user_id : user_id,
        });
                    ...
                    <TouchableOpacity onPress={() => navigation.goBack()} className="mr-4 pt-1">
                        ...
                        <MaskedView
                            maskElement={
                                ...
                                <Text className="text-2xl font-bold text-black">Following</Text>
                                </View>
                            }
                            >
                            <LinearGradient
                                ...
                                className="h-8"
                            >
                                <Text className="text-2xl font-bold opacity-0">Following</Text>
                            </LinearGradient>
                        </MaskedView>
                    </View>
